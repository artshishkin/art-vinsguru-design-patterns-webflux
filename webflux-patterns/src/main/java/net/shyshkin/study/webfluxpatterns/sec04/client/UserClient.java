...
import net.shyshkin.study.webfluxpatterns.sec04.dto.PaymentResponse;
import net.shyshkin.study.webfluxpatterns.sec04.dto.Status;
import net.shyshkin.study.webfluxpatterns.sec04.dto.User;
...
public class UserClient {
    ...
    public UserClient(
            ...
            @Value("${app.external.service.url.sec04.user}") String serverUrl,
