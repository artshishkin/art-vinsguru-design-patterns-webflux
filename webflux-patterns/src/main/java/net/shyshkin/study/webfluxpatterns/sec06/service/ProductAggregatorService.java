package net.shyshkin.study.webfluxpatterns.sec06.service;

import lombok.RequiredArgsConstructor;
import net.shyshkin.study.webfluxpatterns.sec06.client.ProductClient;
import net.shyshkin.study.webfluxpatterns.sec06.client.ReviewClient;
